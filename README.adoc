...
image:https://img.shields.io/badge/License-AGPL--3.0-blue.svg[License: AGPL-3.0,link=./LICENSE]
...
|ChatGPT (full), Claude/Gemini/Copilot (coming v0.2)
...
|**13 CLI Commands**
|import, list, show, search, delete, export, stats, validate, backup, restore, init, tui, version

|**Local-First Storage**
|SQLite database with zero network dependencies

|**Type-Safe Rust**
|1,354 lines of idiomatic Rust, zero unsafe blocks
...
* Claude, Gemini, Copilot import parsers
...
# Gemini (coming v0.2)
llm-unify import gemini ./takeout.json
----
